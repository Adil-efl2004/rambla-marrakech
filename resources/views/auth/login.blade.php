...
<head>
    ...
    <title>Connexion — {{ config('app.name', 'Rambla Marrakech') }}</title>
...
<div class="grid min-h-screen md:grid-cols-2">
    ...
    <div class="relative hidden md:block">
        {{-- Image de fond : patio marocain de luxe, Marrakech (Pexels #6634469 — Moroccan courtyard, libre de droits) --}}
        <img
    ...
    <div class="flex min-h-screen flex-col justify-center bg-parchment px-6 py-12 sm:px-12 lg:px-16">
        <div class="mx-auto w-full max-w-md">
            ...
            {{-- En-tête --}}
            <div class="mb-10">
                <h2 class="font-display text-4xl font-semibold text-ink">Bienvenue</h2>
                <p class="mt-2 text-sm text-stone">Connectez-vous pour accéder à votre espace.</p>
            </div>
            ...
            <a
                ...
                class="flex w-full items-center justify-center gap-3 rounded-lg border border-ink/20 bg-white px-4 py-3 text-sm font-medium text-ink shadow-none transition-colors duration-200 hover:border-ink/40 hover:bg-ink/5 focus:outline-none focus:ring-2 focus:ring-brass focus:ring-offset-2"
            >
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a
                                ...
                                class="text-xs font-semibold text-brass transition-colors duration-200 hover:text-ink focus:outline-none focus:ring-2 focus:ring-brass focus:ring-offset-2 rounded"
                            >
                                Mot de passe oublié ?
                            </a>
                        @endif
                ...
                <div class="flex items-center gap-2">
                    <input
                        ...
                        type="checkbox"
                        name="remember"
                        class="rounded border-ink/20 text-brass shadow-sm focus:ring-brass"
                    >
                    <label for="remember_me" class="text-sm text-stone select-none">
                        Se souvenir de moi
                    </label>
                </div>
